...
//  IMFileManager
//
//  Created by iMokhles on 09/02/2018.
...
public extension Color {
    ...
    class func facebookBlueColor() -> Color
    {
        return Color(hex: "3B5998")
    }
    class func twitterColor() -> Color
    {
        return Color(hex: "55ACEE")
    }
    class func googlePlusColor() -> Color
    {
        return Color(hex: "dd4b39")
    }
    class func youtubeColor() -> Color
    {
        return Color(hex: "CC181E")
    }
    class func instagramColor() -> Color
    {
        return Color(hex: "3F729B")
    }
    class func vimeoColor() -> Color
    {
        return Color(hex: "1ab7ea")
    }
    class func dailyMotionColor() -> Color
    {
        return Color(hex: "0079b8")
    }
    class func soundCloudColor() -> Color
    {
        return Color(hex: "FF3D00")
    }
    class func vineColor() -> Color
    {
        return Color(hex: "00B489")
    }
    class func defaultIMColor() -> Color
    {
        return Color(hex: "009FF9")
    }
